...
| *Qitong Wang*, Themis Palpanas. **Deep Learning Embeddings for Data Series Similarity Search**. ACM SIGKDD International Conference on Knowledge Discovery and Data Mining (KDD), virtual conference, August 2021. ([pdf](/assets/pdf/kdd21-seanet.pdf), [homepage](https://helios.mi.parisdescartes.fr/~themisp/seanet/)) |
